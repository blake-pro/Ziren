...
namespace zkm_recursion_core_sys::poseidon2_skinny {
...
template <class F>
__ZKM_HOSTDEV__ void event_to_row(const Poseidon2Event<F>& event,
...
template <class F>
__ZKM_HOSTDEV__ void instr_to_row(const Poseidon2Instr<F>& instr, size_t i,
