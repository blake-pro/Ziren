...
use crate::syscall::precompiles::keccak256::{KeccakPermuteChip, Keccak256XorChip};
...
/// in the CPU table to determine whether to lookup the syscall.
...
impl SyscallCode {
    ...
    pub fn from_u32(value: u32) -> Self {
        match value {
            ...
            0x00_01_01_30 => SyscallCode::KECCAK256_XOR,
...
pub fn default_syscall_map() -> HashMap<SyscallCode, Arc<dyn Syscall>> {
    ...
    syscall_map.insert(SyscallCode::KECCAK256_XOR, Arc::new(Keccak256XorChip::new()));
    syscall_map
