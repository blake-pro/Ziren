...
mod tests {
    ...
    fn test_malicious_next_pc() {
        ...
        let test_cases = vec![
            TestCase {
                program: vec![
                    Instruction::new(Opcode::ADD, 2, 0, HALT, false, true), // Set the syscall code in register x5.
                    Instruction::new(Opcode::SYSCALL, 2, 4, 5, false, false), // Call the syscall.
            ...
            TestCase {
                program: vec![
                    Instruction::new(Opcode::ADD, 2, 0, SHA_EXTEND, false, true), // Set the syscall code in register x5.
                    Instruction::new(Opcode::ADD, 4, 0, 40, false, true), // Set the syscall arg1 to 40.
                    Instruction::new(Opcode::SYSCALL, 2, 4, 5, false, false), // Call the syscall.
                    Instruction::new(Opcode::ADD, 30, 0, 100, false, true),
                ],
        ...
        for test_case in test_cases {
            ...
            type P = CpuProver<BabyBearPoseidon2, MipsAir<BabyBear>>;
    ...
    fn test_malicious_commit() {
        let instructions = vec![
            Instruction::new(Opcode::ADD, 2, 0, COMMIT, false, true), // Set the syscall code in register x5.
            Instruction::new(Opcode::ADD, 4, 0, 0, false, false), // Set the syscall code in register x5.
            Instruction::new(Opcode::ADD, 5, 0, 40, false, true), // Set the syscall arg1 to 40.
            Instruction::new(Opcode::SYSCALL, 2, 4, 5, false, false), // Call the syscall.
        ];
        let program = Program::new(instructions, 0, 0);
        let stdin = ZKMStdin::new();
    ...
    fn test_malicious_commit_deferred() {
        let instructions = vec![
            Instruction::new(Opcode::ADD, 2, 0, COMMIT_DEFERRED_PROOFS, false, true), // Set the syscall code in register x5.
            Instruction::new(Opcode::ADD, 4, 0, 0, false, false), // Set the syscall code in register x5.
            Instruction::new(Opcode::ADD, 5, 0, 40, false, true), // Set the syscall arg1 to 40.
            Instruction::new(Opcode::SYSCALL, 2, 4, 5, false, false), // Call the syscall.
        ];
